...
/**
 * Thin seam for a later exact curve implementor.
 * Six operations; length / pointAt / isExact do not densify.
 */
...
public:
    ...
    virtual geom::CoordinateXY pointAt(double t) const = 0; // t in [0,1]
